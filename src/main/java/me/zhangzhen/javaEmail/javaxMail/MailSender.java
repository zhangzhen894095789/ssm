...
/**   
  ...
  */    
    public boolean sendTextMail(MailSenderConfig mailInfo) throws Exception{    
      // 判断是否需要身份认证    
      MyEmailAuthenticator authenticator = null;    
      Properties pro = mailInfo.getProperties();   
      if (mailInfo.isValidate()) {    
      // 如果需要身份认证，则创建一个密码验证器    
        authenticator = new MyEmailAuthenticator(mailInfo.getUserName(), mailInfo.getPassword());    
      }   
    ...
    /**   
      ...
      */    
    public  boolean sendHtmlMail(MailSenderConfig mailInfo) throws Exception{    
      // 判断是否需要身份认证    
      MyEmailAuthenticator authenticator = null;   
      Properties pro = mailInfo.getProperties();   
      //如果需要身份认证，则创建一个密码验证器     
    ...
    public static void main(String[] args){   
        //这个类主要是设置邮件   
	     ...
	     mailInfo.setToAddress("894095789@qq.com");    
	     mailInfo.setSubject("hahaha");    
	     mailInfo.setContent("hahhahs");    
	     //这个类主要来发送邮件   
